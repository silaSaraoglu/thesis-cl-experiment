...
#BaselineRNN is from the original GIM repo, with the following modifications:
class SingleHeadLSTM(BaselineRNN):

    def __init__(self, input_size, hidden_size, output_size, batch_size):
        super().__init__(input_size, hidden_size, output_size, 'cpu',lstm=True, batch_size=batch_size, num_layers=1, orthogonal=False)
