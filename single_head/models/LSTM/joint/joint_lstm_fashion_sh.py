"""
Joint Single-Head LSTM -- MNIST  (DIL Setting 1, upper bound).
...
def run_joint_lstm_fashion_sh(args, verbose = True):
    ...
    mnist_train = FashionMNIST_CL(data_dir, download=False, train=True,
                           ...
                           output_size=2)
    mnist_test = FashionMNIST_CL(data_dir, download=False, train=False,
                           output_size=2)
