...
CL strategy: Learning without Forgetting — distillation from the old model's
  soft predictions keeps readout behaviour on past tasks without storing data.
