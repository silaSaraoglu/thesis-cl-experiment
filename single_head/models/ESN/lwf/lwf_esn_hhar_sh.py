"""
ESN with LwF -- HHAR  (Domain-Incremental).

CL strategy: Learning without Forgetting — distillation from the previous model.
...
def run_esn_lwf_hhar(args, verbose = True, trial=None):
