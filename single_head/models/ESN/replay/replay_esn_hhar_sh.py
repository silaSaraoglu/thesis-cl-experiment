"""
ESN with Experience Replay -- HHAR  (Domain-Incremental).

CL strategy: Experience Replay — a fixed-size ring buffer stores past samples.
...
def run_esn_replay_hhar(args, verbose = True, trial=None):
    ...
    if verbose:
        print(f"  HHAR results  --  ESN-Replay")
