"""
ESN Naive (fine-tuning) -- HHAR  (Domain-Incremental).

CL strategy: Naive — plain gradient descent on the readout, no anti-forgetting (lower bound).
...
def run_esn_naive_hhar(args, verbose = True, trial=None):
    ...
    if verbose:
        print(f"  HHAR results  --  ESN-Naive")
