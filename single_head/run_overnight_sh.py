"""
Launch the Single-Head (DIL) pipeline detached from the terminal.
...
Usage:
    ...
    python run_overnight_sh.py --subset 2000 --n_trials 30 --num_runs 3
    python run_overnight_sh.py --results_dir ../results/my_sh_run
...
logfile = os.path.join(LOG_DIR, f"overnight_sh_{timestamp}.log")
