"""
ESN Naive Multi-Head -- HHAR  (TIL Setting 2).

Per-DEVICE independent 6-way linear heads on a shared frozen reservoir.
No forgetting possible (heads independent); oracle device ID at test time.
...
def run_esn_naive_hhar_mh(args, verbose = True, trial=None):
    ...
    if verbose:
        print(f"  HHAR results  --  ESN-Naive MH")
