"""
LSTM with Experience Replay -- WISDM  (TIL Setting 2).
...
def run_lstm_replay_wisdm_mh(args, verbose=True, trial=None):
    ...
    device    = args.device
    model     = MultiHeadLSTM(input_size, hidden_size, device, batch_size)
