"""
Joint Multi-Head LSTM -- WISDM  (TIL Setting 2, upper bound).
...
def run_joint_lstm_wisdm_mh(args, verbose = True):
    """Joint Multi-Head LSTM on WISDM. Returns val_accs, test_accs, metrics, model, []."""


    device      = args.device
    batch_size  = args.batch_size
    epochs      = args.epochs
    model = MultiHeadLSTM(3, args.hidden_size_rnn, device, batch_size)
    ...
    if verbose:
        ...
        print()
        print("  WISDM results  --  LSTM MH (Joint)  [oracle upper bound]")
